        ...
        VStack {
            HStack {
                ...
                Button {
                    ...
                    // FALSCH - Remainder operator anstatt If-Verzweigung
                } label: {
            ...
            Image(names[currentIndex])
                ...
                .scaledToFit()
                .padding()
                .clipShape(RoundedRectangle(cornerRadius: 10)) //FALSCH: .cornerRadius(10)
                .shadow(radius: 20)
            ...
            HStack {
                ...
                Button {
                    repeat { //FALSCH: Nicht drauf gekommen und vorallem Int.random(in: ...) nochmal anschauen!
                        ranNum = Int.random(in: 0...names.count-1)
